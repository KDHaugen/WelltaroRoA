...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_VSPEED, -4);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_VSPEED, -10);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 49);
...
set_hitbox_value(AT_FSTRONG, 1, HG_EXTRA_HITPAUSE, 11);
set_hitbox_value(AT_FSTRONG, 1, HG_DRIFT_MULTIPLIER, 0.01);
...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 42);
